...
- `AGENT_V4_MAX_ROUNDS = 12`
- `AGENT_V4_MAX_ITEMS = 12`
- `AGENT_V4_MAX_REFERENCES = 16`
- `AGENT_V4_REPAIR_ATTEMPTS = 1`
...
- `Agent V4 rollout note = the two server flags are conjunctive; enable V4 only for approved tenants after migration and focused smoke tests. Keep AGENT_V4_* and VITE_AGENT_V4_ENABLED false by default for rollback.`
