...
export function AuthDialog({ children, focusKey, onClose, open, pending, title }: { children: ReactNode; focusKey?: string; onClose: () => void; open: boolean; pending: boolean; title: string }) {
