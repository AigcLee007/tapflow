...
export type AgentComposerProps = {
  ...
  onLayerChange?: (layer: "capability" | "mode" | "model", open: boolean) => void;
  ...
  return (
    <footer className="agent-v6-composer agent-v6-composer-fixed" data-testid="agent-v6-composer">
      ...
      <div className="agent-v6-composer-toolbar">
        ...
        <div className="agent-v6-model" data-composer-slot="model"><MenuSelect label="模型" value={model} options={[...modelOptions]} onChange={(value) => onModelChange?.(value)} onOpenChange={(open) => onLayerChange?.("model", open)} size="compact" /></div>
