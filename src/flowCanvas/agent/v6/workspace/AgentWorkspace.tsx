...
export function AgentWorkspace({ blocks, title, phase, prompt, references, history, historyLoading, historyNow, model, modelOptions, mode = "auto", busy = false, onNewConversation, onRename, onHistorySelect, onPromptChange, onRemoveReference, onRoleChange, onSend, onCancel, onCapability, onModeChange, onModelChange, onCollapse, onBlockAction = () => undefined }: AgentWorkspaceProps) {
