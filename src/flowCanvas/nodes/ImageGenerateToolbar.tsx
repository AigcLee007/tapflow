...
export const IMAGE_GENERATE_TOOLBAR_HEIGHT = 28;
export const IMAGE_GENERATE_TOOLBAR_SEND_BUTTON_SIZE = 24;
export const IMAGE_GENERATE_TOOLBAR_CREDITS_MIN_WIDTH = 54;
...
export function ImageGenerateToolbar({
  ...
  return (
    ...
    >
      ...
      >
        <span style={{ color: '#94a3b8', fontSize: 12, fontWeight: 650 }}>{creditsLabel}</span>
        <span style={{ color: '#f8fafc', fontSize: 13, fontWeight: 800 }}>{creditsValue}</span>
      </div>
