...
describe('image menu style tokens', () => {
  ...
  test('keeps selected image floating toolbar compact', () => {
    ...
    expect(IMAGE_FLOATING_TOOLBAR_PADDING).toBe('4px 8px');
    expect(IMAGE_FLOATING_TOOLBAR_GAP).toBe(4);
    expect(IMAGE_FLOATING_TOOLBAR_ITEM_GAP).toBe(2);
    expect(IMAGE_FLOATING_TOOLBAR_INNER_PADDING).toBe('0 2px');
    expect(IMAGE_FLOATING_TOOLBAR_TEXT_BUTTON_PADDING).toBe('4px 7px');
    expect(IMAGE_FLOATING_TOOLBAR_NODE_GAP).toBe(32);
