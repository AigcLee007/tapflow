...
describe("VideoModeMenu", () => {
  test("renders five radio rows and selects the first and last frame mode", () => {
    ...
    expect(firstLastMode.textContent).toContain("需要首帧和尾帧");
    fireEvent.click(firstLastMode);

    expect(onChange).toHaveBeenCalledWith("first_last_frame");
  });

  test("marks modes unsupported by the selected route as disabled with a reason", () => {
